...
reusable output addresses, and the two expected negative failure paths.
...
with stable output allocations. It does not claim that an actual camera lease,
GPU region-affine pose input, or semantic pose inference has run.
